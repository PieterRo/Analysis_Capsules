...
% work
cd(cfg.rootDir)   % work Mac
if Monkey == 1
    load(fullfile(cfg.dataDir, 'Mr Nilson', 'ObjAtt_lines_normMUA.mat'));
    load(fullfile(cfg.dataDir, 'Mr Nilson', 'ObjAtt_lines_MUA_trials.mat'));
else
    load(fullfile(cfg.dataDir, 'Figaro', 'ObjAtt_lines_normMUA.mat'));
    load(fullfile(cfg.dataDir, 'Figaro', 'ObjAtt_lines_MUA_trials.mat'));
end
